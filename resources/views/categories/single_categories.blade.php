...
<div class="bodybg topspace">
	...
	<div class="tagcloud" style="background:url(/images/scriptolution-cat-imgs/{{$pic}}) no-repeat;">
                ...
                <div class="allmusic">
                    ...
                    <ul id="scriptolutiondontshowcats" class="scriptolutionhide">        
                        @foreach ($data as $x)
                             ...
                             <li><a href="/categories/{{str_replace(' ', '', htmlspecialchars_decode($x->name))}}">{{htmlspecialchars_decode($x->name)}}</a></li>
