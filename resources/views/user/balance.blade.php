		...
		<div class="inner-wrapper">
			...
			<div class="left-side">
				<div class="whiteBox twoHalfs padding15 scriptolutionshop">
                    ...
                    <span class="disabled right"><strong><a href="#">Withdraw your earnings</a></strong></span>
                    </div>
                    
                    <div class="info2" id="wdsection" style="display:none; clear:both">   
                    	                        	                                                            	The minimum withdrawal amount has not been met: ₹725                                                                        </div>
					...
					<div class="whiteBox inside">
						<div class="block inside">
							<span class="number">
                                                        ₹0</span>
							<span class="biggdescr">Available</span>
                            <span class="descr">Cleared funds available for withdrawal or purchasing</span>
						</div>
						<div class="block inside">
							<span class="number">
                                                                ₹0</span>
							<span class="biggdescr">Awaiting Approval</span>
                            <span class="descr">Cleared funds awaiting administrator approval</span>
						</div>
						<div class="block inside last">
							<span class="number">
                                                                ₹0</span>
							<span class="biggdescr">Awaiting Clearance</span>
                            <span class="descr">Incoming payments that are not yet cleared for approval</span>
						</div>
					</div>
                    ...
                    <div class="whiteBox inside">
						<div class="block inside">
							<span class="number">
                                                                ₹0</span>
							<span class="biggdescr">Upcoming Payments</span>
                            <span class="descr">Expected revenues from orders in progress</span>
						</div>
						<div class="block inside">
							<span class="number">
                                                                ₹0</span>
							<span class="biggdescr">Already Withdrawn</span>
                            <span class="descr">Funds you transferred to your PayPal account</span>
						</div>
						<div class="block inside last">
							<span class="number">
                                                                ₹0</span>
							<span class="biggdescr">Revenue Purchases</span>
                            <span class="descr">Revenues you used to pay for other jobs</span>
						</div>
					</div>
                    ...
                    <div class="whiteBox inside">
						<div style="font-size: 18px; color: #208305;">Since you joined you made 
                                                        ₹0</div>
					</div>
