...
$(document).ready( function() {
    var base_url = '<?php echo $config['baseurl']; ?>';
    var Scriptolution = {};
    ...
    $('#fileInput').uploadify({	  
	  'uploader'  : '<?php echo $config['baseurl']; ?>/js/uploadify.swf',
      'script'    : '<?php echo $config['baseurl']; ?>/upload',
      'cancelImg' : '<?php echo $config['baseurl']; ?>/images/jcancel.png',
      'buttonImg' : '<?php echo $config['baseurl']; ?>/images/jbrowse.png',
      'wmode'     : 'transparent',
      'width'     : 81,
      'height'    : 25,
      'rollover'  : false,
	...
	$("#new_message.nonajaxy").submit(function(event) {
		$('.msg-error').hide();
