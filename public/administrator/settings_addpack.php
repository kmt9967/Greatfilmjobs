...
if($_POST['submitform'] == "1")
{
	...
	else
	{
		...
		$sql = "insert into packs set pprice='".mysqli_real_escape_string($conn->_connectionID, $pprice)."', pcom='".mysqli_real_escape_string($conn->_connectionID, $pcom)."', l1='".mysqli_real_escape_string($conn->_connectionID, $l1)."', l2='".mysqli_real_escape_string($conn->_connectionID, $l2)."', l3='".mysqli_real_escape_string($conn->_connectionID, $l3)."'";
		$conn->execute($sql);
