...
if($_REQUEST['delete']=="1")
{
	...
	if($DPID > 0)
	{
		...
		$query = "DELETE FROM extras WHERE PID='".mysqli_real_escape_string($conn->_connectionID, $PID)."'";
		$conn->Execute($query);
...
if($_POST['asub']=="1")
{
	...
	$sql="UPDATE posts SET active='1' WHERE PID='".mysqli_real_escape_string($conn->_connectionID, $APID)."'";
	$conn->Execute($sql);
	Stemplate::assign('message',$message);
}
//ACTIVE
