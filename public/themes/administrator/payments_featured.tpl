							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" " align="center"><a href="{$adminurl}/gigs_manage.php?page=1&sortby=PID&sorthow=desc&fromid={$results[i].PID}&toid={$results[i].PID}">{$results[i].PID} ({$results[i].gtitle|stripslashes})</a></td>
                                        ...
                                        <td class=" " style="background-color:#FFC">
                                            ...
                                            {elseif $results[i].fiverrscriptdotcom_fstripe eq "1"}
                                            	Stripe
                                            {else}
                                            	Account Balance
                                            {/if}
