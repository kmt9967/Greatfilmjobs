                                    ...
                                    <table cellspacing="0" style="border:0;" id="lastOrdersGrid_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class=" a-center last">{insert name=get_total_com value=var table=orders}</td>
                                        	</tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table cellspacing="0" style="border:0;" id="lastOrdersGrid_table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class=" a-center last">{insert name=get_total_com value=var table=wants}</td>
                                        	</tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table cellspacing="0" style="border:0;" id="lastOrdersGrid_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class=" a-center last">{insert name=get_total_com value=var table=payments}</td>
                                        	</tr>
                                        </tbody>
                                    </table>
                                </div>
