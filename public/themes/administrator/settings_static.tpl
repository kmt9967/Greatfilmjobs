                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input name="title6" value="{$static6.title|stripslashes|htmlspecialchars}" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Job Levels Data </label></td>
                                                        <td class="value">
                                                            <textarea name="value6" class=" textarea ckeditor" type="textarea" >{$static6.value|stripslashes|htmlspecialchars}</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                        <td class="label">
