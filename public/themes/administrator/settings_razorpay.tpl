                                                ...
                                                <tbody>                    
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" {if $enable_razorpay eq "1"}selected{/if}>Yes</option>
                                                            <option value="0" {if $enable_razorpay eq "0"}selected{/if}>No</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="razorpay_public" name="razorpay_public" value="{$razorpay_public}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="razorpay_private" name="razorpay_private" value="{$razorpay_private}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
