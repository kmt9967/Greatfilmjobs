                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        <td class=" a-right ">{$results[i].CATID}</td>
                                        <td class=" ">{$results[i].name|stripslashes}</td>
                                        <td class=" ">{if $results[i].parent eq "0"}None{else}{insert name=get_cat value=var CATID=$results[i].parent}{/if}</td>
                                        <td class=" last"><a href="cat_edit.php?CATID={$results[i].CATID}">Edit</a>&nbsp;|&nbsp;<a href="cat_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&name={$name}&details={$details}{/if}&delete=1&CATID={$results[i].CATID}">Delete</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="3">
