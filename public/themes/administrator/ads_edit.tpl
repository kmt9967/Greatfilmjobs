				...
				<div class="columns ">
                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                	...
                                                	<tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<textarea id="c" name="c" class=" textarea" type="textarea" >{$ad.code|stripslashes}</textarea>
                                                        </td>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <form action="ads_edit.php?AID={$AID}" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
