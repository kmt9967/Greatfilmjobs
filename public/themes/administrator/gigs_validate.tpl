	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                            ...
                                            <a href="javascript: document.a{$results[i].PID}.submit();">Approve</a>&nbsp;|&nbsp;
                                            <a href="gigs_edit.php?PID={$results[i].PID}">Edit</a>&nbsp;|&nbsp;
                                            <a href="gigs_validate.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&title={$title}&gtitle={$gtitle}&username={$username}&active={$active}{/if}&delete=1&PID={$results[i].PID}">Delete</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="6">
