            ...
            <div id="page:main-container">
				<div class="columns ">
        			...
        			<div id="customerGrid">
        				...
        				<tr>
                    		<td class="pager">
                            	Showing {if $total gt 0}{$beginning} - {$ending} of {/if}{$total} Words
                    		</td>
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="bans_words.php?page={$currentpage}&sortby=word&sorthow={if $sortby eq "word"}{if $sorthow eq "desc"}asc{else}desc{/if}{else}{$sorthow}{/if}{if $search eq "1"}&word={$word}{/if}" name="words" class="{if $sortby eq "word"}sort-arrow-{if $sorthow eq "desc"}desc{else}asc{/if}{else}not-sort{/if}"><span class="sort-title">Word</span></a></span></th>
                                        <th  class=" no-link last"><span class="nobr">Action</span></th>
	                	            </tr>
	            	            	<tr class="filter">
                                        <th ><input type="text" name="word" id="word" value="{$word|stripslashes}" class="input-text no-changes"/></th>
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        <td class=" a-right ">{$results[i].word}</td>
                                        <td class=" last"><a href="bans_words.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&word={$word}{/if}&delete=1&DW={$results[i].word}">Delete</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="2">
