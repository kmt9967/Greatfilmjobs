                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" {if $enable_ref eq "1"}selected{/if}>Yes</option>
                											<option value="0" {if $enable_ref eq "0"}selected{/if}>No</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="ref_price" name="ref_price" value="{$ref_price}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
