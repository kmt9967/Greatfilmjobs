  ...
  <?php if(isset(auth()->user()->id)): ?>
            <div class="logoutheader">
                <div class="usernamebox droparrow">
                                      <div class="userimage"><a href="/user/<?php echo e(auth()->user()->username); ?>"><img src="/images/membersprofilepic/thumbs/<?php echo e(auth()->user()->profilepicture); ?>" alt="<?php echo e(auth()->user()->username); ?>" height="25px" width="25px" class="scriptolutionradius3" /></a></div>
                    <p>Profile</p>
                       <div class="clear"></div>
	...
	<div class="subnav">
    	<div class="centerwrap">
            ...
            <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                
            	<li><a href="/categories/Cinematography---Animation"><?php echo e(htmlspecialchars_decode($x->name)); ?></a>
                <?php if($x->name!="Others"): ?>
                <div class="menubox">
                    	<div class="menulist">
                        	<ul> <?php ($data = App\Models\Categories::select('name')->where('parent', '=', $x->CATID)->
                                get()); ?>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            	    <li><a href="/categories/<?php echo e(str_replace(' ', '', htmlspecialchars_decode($d->name))); ?>"><?php echo e(htmlspecialchars_decode($d->name)); ?></a></li>
             ...
             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                   <li class="submenu-right"><a href="/categories">More</a></li>
            </ul>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\greatfilmjob\resources\views/layout/header.blade.php ENDPATH**/ ?>