...
<div class="bodybg ">
	<div class="bodyshadow">
        ...
        <div class="whitebody <?php if(isset(auth()->user()->id)): ?> scriptolutionpaddingtop55 <?php endif; ?>">
    ...
    <?php ($block = App\Models\Categories::select('scriptolution_cattag1','scriptolution_cattag2','scriptolution_cattag3','scriptolution_catimage','name','seo')->where('scriptolution_featuredcat','=',1)->orderBy('name','desc')->get()); ?> 
            <?php $__currentLoopData = $block; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
            <?php ($name=htmlspecialchars_decode($x->name)); ?>
                <div class="scriptolutionsblock ">
                <div class="songperson">
                    <a href="/categories/<?php echo e($name); ?>?s=p"><img src="/images/scriptolution-cat-imgs/<?php echo e($x->scriptolution_catimage); ?>?1613322127" alt="<?php echo e($name); ?>" width="285" height="145" /></a>
                </div>
                <p>
                    <a href="/categories/<?php echo e($name); ?>?s=p"><?php echo e($name); ?></a>                    
                </p>
                <a href="/categories/<?php echo e($x->seo); ?>">
                <ul class="scriptolution-t-tags" style="padding-top:5px;">
                	<li><?php echo e($x->scriptolution_cattag1); ?></li>                    <li><?php echo e($x->scriptolution_cattag2); ?></li>                    <li><?php echo e($x->scriptolution_cattag3); ?></li>                </ul>
                </a>
                </div>
                ...
                <div class="cusongslist">
                    ...
                    <?php $__currentLoopData = $block; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="cusongsblock ">
                            <div class="songperson">
                            	<a href="/<?php echo e($x->seo); ?>/<?php echo e($x->PID); ?>/<?php echo e($x->gtitle); ?>"><img src="/pics/t3/<?php echo e($x->p1); ?>" alt="<?php echo e($x->p1); ?>" width="214" height="132" /></a>
                                                                                                                            </div>
                            <div class="price 222">
                                <?php $value=$x->price;
                                     echo $value*159.05;
                                     ?></div>
                            <p>
                            	                            	<a href="/<?php echo e($x->seo); ?>/<?php echo e($x->PID); ?>/<?php echo e($x->gtitle); ?>">I will <?php echo e($x->gtitle); ?> 
                                      <?php $value=$x->price;
                                     echo $value*159.05;
                                     ?></a>
                               ...
                               ?>
                                                        <div class="userdata">
                                <div class="userimg"><a href="/user/<?php echo e($u[0]->username); ?>"><img width="25px" height="25px" src="/images/membersprofilepic/thumbs/<?php echo e($pic); ?>" alt="<?php echo e($u[0]->username); ?>" /></a></div>
                                <div class="username"><a href="/user/<?php echo e($u[0]->username); ?>"><?php echo e($u[0]->username); ?></a></div>
                                <div class="otherdetails">
                                    ...
                                    <span class="flag"><span class="country <?php echo e($u[0]->country); ?>" ></span></span>
                                    <div class="clear"></div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\greatfilmjob\resources\views/index.blade.php ENDPATH**/ ?>